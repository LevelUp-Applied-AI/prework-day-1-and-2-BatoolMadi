...
I am Batool Madi, and this repository contains my pre-work assignments for the AI.SPIRE program.

## Setup

```bash
git clone https://github.com/LevelUp-Applied-AI/prework-day-1-and-2-BatoolMadi.git
cd prework-day-1-and-2-BatoolMadi
